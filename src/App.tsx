          ...
          <div className="max-w-4xl mx-auto py-12 md:py-16 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center" id="landing-container">
            ...
            <div className="bg-white rounded-[32px] p-8 border border-natural-border shadow-md space-y-6 text-center" id="login-card">
              ...
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 cursor-pointer border border-natural-border rounded-xl hover:bg-[#f8f7f2] bg-white transition py-3 px-4 shadow-xs"
                id="gsi-signin"
              >
                ...
                <span className="font-bold text-natural-text text-sm">Sign in with Google</span>
              </button>
